...
class CalloutRendererExtension implements NodeRendererInterface
{
	...
	protected function parseNode(Node $node): array
	{
		...
		if ($child instanceof Text && preg_match('#^\[!(note|tip|important|warning|caution)]$#i', $child->getLiteral(), $matches)) {
			...
			return match ($matches[1]) {
				'note' => [
					'border-l-4 border-blue-700 bg-blue-50 pl-4 py-2 my-4 max-w-4xl',
					'text-blue-700 flex items-center font-semibold',
					'Note',
				...
				'tip' => [
					'border-l-4 border-green-700 bg-green-50 pl-4 py-2 my-4 max-w-4xl',
					'text-green-700 flex items-center font-semibold',
					'Tip',
				...
				'important' => [
					'border-l-4 border-purple-700 bg-purple-50 pl-4 py-2 my-4 max-w-4xl',
					'text-purple-700 flex items-center font-semibold',
					'Important',
				...
				'warning' => [
					'border-l-4 border-yellow-600 bg-yellow-50 pl-4 py-2 my-4 max-w-4xl',
				...
				'caution' => [
					'border-l-4 border-red-500 bg-red-50 pl-4 py-2 my-4 max-w-4xl',
